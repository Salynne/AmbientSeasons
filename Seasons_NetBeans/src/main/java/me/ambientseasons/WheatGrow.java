...
public class WheatGrow implements Runnable
{
    ...
    public void run()
    {
        ...
        {
            //If it's Desert, Savannah or Tundra it's just too damn hot/cold to grow well.
            
            
            //Has a 66% chance of de-growing
            int chance = Random(0, 2);
            plugin.log.info("Random Number: " + chance);
            if (chance != 0)
                data--;            
        }
        ...
        {
            //If it's a Rain Forest, Swampland, or Seasonal Forest it's too wet to really grow well.
            
            //Has a 33% chance of de-growing
            int chance = Random(0, 1);
            plugin.log.info("Random Number 2:" + chance);
            if (chance == 0)
                data--;
        }
